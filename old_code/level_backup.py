...
class Level:
    ...
    def scroll_x(self):
        """
        Applies horizontal scrolling to the level
        """
    ...
    def horizontal_collision(self):
        ...
        # add anything to allow the player to collide with here
    ...
    def vertical_collision(self):
        ...
        # add anything to allow the player to collide with here
        collidable_sprites = self.terrain_sprites
    ...
    def run(self): # drawing of the level
